        ...
        {TEAM_MEMBERS.map((dev) => (
          ...
          >
            <div className="space-y-4">
              ...
              <div className={`w-28 h-28 mx-auto rounded-3xl bg-gradient-to-tr ${dev.color} text-white font-extrabold text-3xl flex items-center justify-center shadow-xl shadow-sky-500/20 tracking-wider font-['Hanken_Grotesk']`}>
                {dev.initials}
              </div>
            ...
            {/* Social Buttons */}
            <div className="pt-6 border-t border-slate-100 flex items-center justify-center gap-3 font-mono text-xs font-bold">
              <a
                href={dev.linkedin}
                target="_blank"
                rel="noreferrer"
                className="flex-1 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-800 transition-colors flex items-center justify-center gap-1.5"
              >
